...
mod <- bass(x, y, nmcmc = 20, nburn = 10, thin = 1, 
...
<<ex5plot1, fig.cap='Prediction performance - air foil data.'>>=
...
<<ex5plot2, cache=T, fig.height=6, fig.width=12, out.width='.8\\linewidth', fig.cap='Sobol decomposition - air foil data.'>>=
